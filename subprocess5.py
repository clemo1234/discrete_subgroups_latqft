...
def run_cpp_instance(beta_val,core):
    ...
    process = subprocess.Popen("./dym-mod-metro_N300 ./groups/myBO 4 4 5 0.000000e+00 " + str(beta_val)+ " 0.000000e+00 " + str(generate_random_number()), stdout=subprocess.PIPE, shell=True)
